    ...
    class Program
    {
        ...
        public static void arbitrageHFT()
        {
            ...
            try
            {
                ...
                entryBraziliexBitCointrade.sleep = 100;
                entryBraziliexBitCointrade.perc = 1;
                entryBraziliexBitCointrade.amount = 0.001m;
                ...
                entryBitCointradeBraziliex.sleep = 100;
                entryBitCointradeBraziliex.perc = 1;
                entryBitCointradeBraziliex.amount = 0.001m;
